...
public class FlickrFetchr {
    ...
    public static final String RREF_SEARCH_QUERY = "searchQuery";
    ...
    public static ArrayList<GalleryItem> downloadGalleryItems(String url) {
    ...
    public static ArrayList<GalleryItem> search(String query) {
